...
import { Ref, Class, Obj, Mixin, ClassifierKind, Classifier, Attribute, Type, Text, Property, mixinKey, PropertyType, SetOf } from '@anticrm/core'
...
export function Set () {
  ...
  return function (target: any, propertyKey: string): void {
    const attribute = getAttribute(target, propertyKey)
    const type = { _class: CORE_CLASS_SETOF, of: { _class: CORE_CLASS_TYPE }} as unknown as SetOf<any>
    attribute.type = type
  }
}
